...
class TFDatasetAccessor:
    ...
    ``xr.Dataset`` with transfer-function variables and provides convenience
    mutation methods for common MT workflows.

    Notes
    -----
    The underlying dataset is expected to contain transfer-function variables
    with dimensions ``('period', 'output', 'input')`` and corresponding period
    coordinates.
    ...
    def validate(self) -> bool:
        ...
        ------
        KeyError
            If required transfer-function variables, dimensions, or coordinates
            are missing.
        """
    ...
    def z(self, units: str | None = None) -> np.ndarray:
        ...
        units : str or None, default=None
            Output impedance units. If ``None``, uses dataset attribute
            ``impedance_units`` (falling back to ``"mt"``).
    ...
    def to_z(self, units: str | None = None) -> Z:
        """Build a :class:`Z` object from dataset values.

        Parameters
        ----------
        units : str or None, default=None
            Units for the returned ``Z`` object. If ``None``, uses
            ``self.impedance_units``.
    ...
    def to_tipper(self) -> Tipper:
        """Build a :class:`Tipper` object from dataset values.
    ...
    def to_pt(self) -> PhaseTensor:
        """Build a :class:`PhaseTensor` object from dataset impedance.
    ...
    def with_z(
        ...
        Parameters
        ----------
        z_obj : Z or None, default=None
            Source ``Z`` object. If provided, array arguments are ignored.
        z : numpy.ndarray or None, default=None
            Impedance array used when ``z_obj`` is not provided.
        z_error : numpy.ndarray or None, default=None
            Impedance error array.
        z_model_error : numpy.ndarray or None, default=None
            Impedance model-error array.
        frequency : numpy.ndarray or None, default=None
            Frequency vector for array-mode input.
        period : numpy.ndarray or None, default=None
            Period vector alternative to ``frequency``.
        units : str, default="mt"
            Units for array-mode impedance input.
        inplace : bool, default=False
            If ``True``, mutate the bound dataset and return it.
        ...
        ------
        ValueError
            If input mode is ambiguous or insufficient.
    ...
    def with_tipper(
        ...
        Parameters
        ----------
        tipper_obj : Tipper or None, default=None
            Source ``Tipper`` object. If provided, array arguments are ignored.
        tipper : numpy.ndarray or None, default=None
            Tipper array used when ``tipper_obj`` is not provided.
        tipper_error : numpy.ndarray or None, default=None
            Tipper error array.
        tipper_model_error : numpy.ndarray or None, default=None
            Tipper model-error array.
        frequency : numpy.ndarray or None, default=None
            Frequency vector for array-mode input.
        period : numpy.ndarray or None, default=None
            Period vector alternative to ``frequency``.
    ...
    def with_res_phase(
        ...
        Parameters
        ----------
        resistivity : numpy.ndarray
            Apparent resistivity array with impedance component shape.
        phase : numpy.ndarray
            Impedance phase array in degrees.
        frequency : numpy.ndarray or None, default=None
            Frequency vector. If ``None``, uses dataset frequency.
        period : numpy.ndarray or None, default=None
            Period vector alternative to ``frequency``.
        res_error : numpy.ndarray or None, default=None
            Resistivity error array.
        phase_error : numpy.ndarray or None, default=None
            Phase error array.
        res_model_error : numpy.ndarray or None, default=None
            Resistivity model-error array.
        phase_model_error : numpy.ndarray or None, default=None
            Phase model-error array.
        units : str, default="mt"
            Impedance units for the intermediate ``Z`` representation.
        inplace : bool, default=False
            If ``True``, mutate the bound dataset and return it.
    ...
    def set_resistivity_phase(
        ...
        This is a convenience wrapper around :meth:`with_res_phase` with
        default ``inplace=True``.

        Parameters
        ----------
        resistivity : numpy.ndarray
            Apparent resistivity array.
        phase : numpy.ndarray
            Impedance phase array in degrees.
        ...
        inplace : bool, default=True
            If ``True``, mutate in place and return ``None``.
    ...
    def set_amp_phase(
        ...
        ----------
        r : numpy.ndarray
            Tipper amplitude values.
        phi : numpy.ndarray
            Tipper phase values in degrees.
        inplace : bool, default=True
            If ``True``, mutate in place and return ``None``.
    ...
    def set_mag_direction(
        ...
        Parameters
        ----------
        mag_real : numpy.ndarray
            Magnitude of real tipper vector.
        ang_real : numpy.ndarray
            Direction of real tipper vector in degrees.
        mag_imag : numpy.ndarray
            Magnitude of imaginary tipper vector.
        ang_imag : numpy.ndarray
            Direction of imaginary tipper vector in degrees.
        inplace : bool, default=True
            If ``True``, mutate in place and return ``None``.
    ...
    def rotate(
        ...
        Parameters
        ----------
        alpha : float, int, str, list, tuple, or numpy.ndarray
            Rotation angle(s) passed through to ``Z.rotate`` and
            ``Tipper.rotate``.
        inplace : bool, default=False
            If ``True``, mutate the bound dataset and return ``None``.
        coordinate_reference_frame : str, default="ned"
            Coordinate reference frame used for rotation semantics.
        ...
        ------
        ValueError
            If no impedance or tipper channels can be identified for rotation.
    ...
    def interpolate(
        ...
        **kwargs: Any,
        ...
        Interpolation is performed component-by-component for each
        output/input channel pair.

        Parameters
        ----------
        new_periods : numpy.ndarray
            Target periods in seconds.
        inplace : bool, default=False
            If ``True``, mutate the bound dataset and return ``None``.
        method : str, default="slinear"
            Interpolation method. Supported methods include ``linear``,
            ``cubic``, ``nearest``, ``slinear``, ``quadratic``, ``zero``,
            ``previous``, ``next``, ``pchip``, ``spline``, ``akima``,
            ``barycentric``, ``polynomial``, and ``krogh``.
        extrapolate : bool, default=False
            If ``True``, allow values outside source period range.
        **kwargs
            Additional keyword arguments forwarded to the selected scipy
            interpolator.
    ...
    def _get_interpolator(
        ...
        **kwargs: Any,
        ...
        """Build a scipy interpolator for the requested method.
        ...
        extrapolate : bool, default=False
            Whether to permit extrapolation beyond ``x`` bounds.
        **kwargs
    ...
    def remove_ss(
        ...
        as_dataset : bool, optional
            If ``True``, return corrected transfer-function dataset.
            If ``False``,
    ...
    def remove_distortion(
        ...
        Parameters
        ----------
        distortion_tensor : numpy.ndarray or None, optional
            Distortion tensor estimate.
        distortion_error_tensor : numpy.ndarray or None, optional
            Distortion tensor error estimate.
        n_frequencies : int or None, optional
            Number of frequencies used for estimation when an explicit tensor is
            not provided.
        comp : str, default="det"
            Impedance component selection strategy.
        only_2d : bool, default=False
            If ``True``, constrain correction to 2D assumptions.
        units : str or None, optional
            Impedance unit system passed to :meth:`to_z`.
        as_dataset : bool, default=False
            If ``True``, return corrected transfer-function dataset.
            If ``False``, return corrected :class:`Z` object.
    ...
    def estimate_dimensionality(
        ...
        Parameters
        ----------
        skew_threshold : float, default=5
            Skew threshold (degrees) used to discriminate dimensionality.
        eccentricity_threshold : float, default=0.1
            Eccentricity threshold used to discriminate dimensionality.
    ...
    def estimate_distortion(
        ...
        ----------
        n_frequencies : int or None, optional
            Number of frequencies to include in the estimate.
        comp : str, default="det"
            Impedance component selection strategy.
        only_2d : bool, default=False
            If ``True``, constrain the estimate to 2D assumptions.
        clockwise : bool, default=True
            Rotation-direction convention used internally.
